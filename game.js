...
function addItems() {
  ...
  createItem(205, 500, 'coin');
  createItem(350, 400, 'coin');
  createItem(700, 400, 'coin');
  createItem(350, 300, 'coin');
  createItem(400, 200, 'coin');
  createItem(575, 475, 'coin');
  createItem(700, 200, 'coin');
  createItem(150, 325, 'coin');
  createItem(625, 275, 'poison');
  createItem(370, 500, 'poison');
  createItem(150, 425, 'poison');
  createItem(375, 90, 'star');
}

// add platforms to the game
function addPlatforms() {
  platforms = game.add.physicsGroup();
  platforms.create(500, 525, 'platform');
  platforms.create(100, 550, 'platform');
  platforms.create(300, 125, 'platform');
  platforms.create(50, 375, 'platform');
  platforms.create(300, 250, 'platform');
  platforms.create(650, 450, 'platform');
  platforms.create(650, 275, 'platform2');
...
function createBadge() {
  ...
  var badge = badges.create(100, 50, 'badge');
